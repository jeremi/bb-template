...
| **Spectral ruleset** | To be authored alongside v1.0 | Machine-enforceable subset of the guide's rules ([§20](../part-e/20-conformance-and-validation.md)). v0.1 covers OpenAPI, CloudEvents, and AsyncAPI documentation rules; protocol-profile rules may be added later. |
