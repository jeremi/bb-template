...
This checks that the file is a structurally valid AsyncAPI 3 document. It is the mechanical check behind [3.4](../part-a/3-asyncapi-document-standards.md#34-passes-an-asyncapi-validator).
